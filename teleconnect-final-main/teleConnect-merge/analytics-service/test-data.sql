...
INSERT INTO subscriber_accounts (account_id, subscriber_id, account_type, registration_date, region_id, status) VALUES
...
INSERT INTO sim_lines (line_id, account_id, activation_date, status) VALUES
...
INSERT INTO invoices (invoice_id, account_id, cycle_id, total_amount, paid_amount, due_date, status) VALUES
...
INSERT INTO billing_disputes (dispute_id, subscriber_id, invoice_id, status, raised_date) VALUES
...
INSERT INTO usage_summaries (summary_id, line_id, billing_cycle_id, data_used_mb, voice_used_min, sms_used) VALUES
...
INSERT INTO fault_tickets (ticket_id, account_id, line_id, priority, raised_date, resolved_date, status) VALUES
...
-- ============================================================================
-- This is for persisting generated reports locally in analytics service.
-- Reports will be auto-generated from the above data via the REST APIs.

-- Optional: Pre-populate one sample report if needed
INSERT INTO telecom_reports (scope, scope_value, period_start, period_end, metrics, generated_by) VALUES
